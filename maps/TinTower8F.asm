...
TinTower8F_MapEvents:
	...
	warp_event 18,  1, TIN_TOWER_9F, 1
	warp_event 14,  7, TIN_TOWER_9F, 2
	warp_event  4,  7, TIN_TOWER_9F, 3
	...
	object_event  2, 11, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, TinTower8FFullRestore, EVENT_TIN_TOWER_8F_FULL_RESTORE
