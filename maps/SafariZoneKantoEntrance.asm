...
SafariZoneKantoEntrance_MapScripts:
	...
	def_callbacks
	callback MAPCALLBACK_OBJECTS, SafariZoneKantoEntranceOfficerCallback

SafariZoneKantoEntranceOfficerCallback:
	checkflag ENGINE_SAFARI_ZONE
	iftrue .SafariGameActive

; Normal entrance state: main officer is at the desk.
...
.SafariGameActive:
; Active Safari state: officer has moved to the upper-left position.
	...
	disappear SAFARI_ZONE_KANTO_ENTRANCE_OFFICER2
	appear SAFARI_ZONE_KANTO_ENTRANCE_OFFICER3
	endcallback
