...
SafariZoneKantoArea4_MapEvents:
	...
	def_object_events
	object_event 15, 11, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, PERSONTYPE_ITEMBALL, 0, SafariZoneKantoArea4GoldLeaf, EVENT_SAFARI_ZONE_KANTO_AREA_4_GOLD_LEAF
	object_event  7,  2, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, PERSONTYPE_ITEMBALL, 0, SafariZoneKantoArea4MaxEther, EVENT_SAFARI_ZONE_KANTO_AREA_4_MAX_ETHER
	object_event 13, 12, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, PERSONTYPE_ITEMBALL, 0, SafariZoneKantoArea4MaxPotion, EVENT_SAFARI_ZONE_KANTO_AREA_4_MAX_POTION
	object_event 19,  7, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, PERSONTYPE_ITEMBALL, 0, SafariZoneKantoArea4MaxRevive, EVENT_SAFARI_ZONE_KANTO_AREA_4_MAX_REVIVE
