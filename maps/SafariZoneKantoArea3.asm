...
SafariZoneKantoArea3_MapEvents:
	...
	def_object_events
	object_event 15, 20, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, PERSONTYPE_ITEMBALL, 0, SafariZoneKantoArea3LuckyPunch, EVENT_SAFARI_ZONE_KANTO_AREA_3_LUCKY_PUNCH
	object_event 38,  2, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, PERSONTYPE_ITEMBALL, 0, SafariZoneKantoArea3Protein, EVENT_SAFARI_ZONE_KANTO_AREA_3_PROTEIN
	object_event 19,  9, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, PERSONTYPE_ITEMBALL, 0, SafariZoneKantoArea3KingsRock, EVENT_SAFARI_ZONE_KANTO_AREA_3_KINGS_ROCK
