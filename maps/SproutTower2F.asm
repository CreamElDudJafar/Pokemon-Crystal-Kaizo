...
SproutTower2F_MapEvents:
	...
	def_warp_events
	warp_event  3,  11, SPROUT_TOWER_1F, 3
	warp_event 13,  15, SPROUT_TOWER_1F, 4
	warp_event  3,   1, SPROUT_TOWER_1F, 5
	warp_event  9,  15, SPROUT_TOWER_3F, 1

	def_coord_events

	def_bg_events
	bg_event  9, 13, BGEVENT_READ, SproutTower2FStatue

	def_object_events
	object_event 18,  5, SPRITE_SAGE, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 4, TrainerSageNico, -1
