...
;INCLUDE "engine/pokemon/correct_party_errors.asm" ; Unreferenced so removed for space
...
;INCLUDE "engine/link/init_list.asm" ; Removed due to function being useless
