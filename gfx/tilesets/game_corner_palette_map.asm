	...
	tilepal 1, RED, RED, WATER, WATER, GREEN, GRAY, RED, RED
	tilepal 1, RED, RED, YELLOW, YELLOW, WATER, WATER, WATER, BROWN
	tilepal 1, BROWN, BROWN, WATER, WATER, GREEN, ROOF, RED, RED
