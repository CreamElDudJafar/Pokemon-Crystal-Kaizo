...
; Viridian Forest Bug Catchers
	const EVENT_BEAT_VIRIDIAN_FOREST_BUG_CATCHER_1
	const EVENT_BEAT_VIRIDIAN_FOREST_BUG_CATCHER_2
	const EVENT_BEAT_VIRIDIAN_FOREST_BUG_CATCHER_3
; Cerulean Cave
	const EVENT_CERULEAN_CAVE_1F_ULTRA_BALL_1
	const EVENT_CERULEAN_CAVE_1F_ULTRA_BALL_2
	const EVENT_CERULEAN_CAVE_2F_NUGGET_1
	const EVENT_CERULEAN_CAVE_2F_NUGGET_2
